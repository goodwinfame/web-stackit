...
export default () => {
    ...
    function updateSearchInput(value: string | Store.SetStateCallback<Store.SearchInput>, state: inputState): void {
    ...
    function updateView(state: viewState | Store.SetStateCallback<Store.MainView>, value: number | null): void {
        if(arguments.length === 1 && typeof(arguments[0]) === "function") {
    ...
    function updateQuestionList(value: Store.questionList | Store.SetStateCallback<Store.QuestionListState>, pageNum: number, state: listState): void {
        if(arguments.length === 1 && typeof(arguments[0]) === "function") {
